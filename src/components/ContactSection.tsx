            ...
            <CardContent className="space-y-8">
              <div className="grid md:grid-cols-2 gap-6">
                {contactInfo.map((contact, index) => {
                  // Only make email clickable
                  if (contact.label === "Email") {
                    return (
                      <a key={index} href={contact.href} target="_self" className="group">
                  ...
                  // For other cards, remove the anchor link
                  return (
                    <div key={index} className="group">
                      <Card className="shadow-card transition-all duration-300 bg-white/5 border-white/20">
                        <CardContent className="p-6 flex items-center gap-4">
                          <div className="flex-shrink-0">
                            <div className="w-12 h-12 bg-gradient-primary rounded-full flex items-center justify-center shadow-glow">
                              <contact.icon className="w-6 h-6 text-white" />
