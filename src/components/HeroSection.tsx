...
const HeroSection = () => {
  return <section className="relative min-h-screen flex items-center justify-center bg-gradient-hero text-white overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12 animate-slide-up" style={{
        animationDelay: "0.3s"
      }}>
        ...
        <div className="flex flex-wrap justify-center gap-6 text-sm text-white/70 animate-fade-in" style={{
        animationDelay: "0.6s"
      }}>
